    ...
    <div class="row" id="auth">
        <div class="col-12 col-md-4 offset-md-4 mt-4 mt-md-5 ">
            ...
            <form action="{{ route('register.store') }}" method="POST">
                ...
                <div class="input-container">
                    <div class="input @error('name') is-invalid @enderror">
                        <input type="text" placeholder="Soyadınız" class="form-control" name="surname" id="surname"
                            value="{{ old('surname') }}" required minlength="2" maxlength="50">
                ...
                <div class="input-container">
                    <div class="input @error('email') is-invalid @enderror">
                        <input type="email" placeholder="E-posta adresiniz" class="form-control" name="email"
                            id="email" value="{{ old('email') }}" required minlength="4" maxlength="80">
                ...
                <div class="input-container">
                    <div class="input @error('password') is-invalid @enderror">
                        <input type="password" placeholder="Şifreniz" class="form-control" name="password" id="password"
                            value="{{ old('password') }}" required minlength="6" maxlength="50">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <p>
                            ...
                            kullanacaksanız, metin aralarına utandırıcı sözcükler gizlenmediğinden emin olmanız gerekir.
                        </p>
                    </div>
                </div>
